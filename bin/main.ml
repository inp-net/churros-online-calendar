    ...
    "homepage": {
      "nodes": [
        ...
        },
        {
          ...
          "bodyPreview": "Tu es intéressé par des projets en lien avec le spatial ? Tu veux construire une",
          "reactionCounts": "{\"❤️\":1}"
        },
        {
        ...
        },
        {
          ...
          "bodyPreview": "🪓Les vikings ne choisissaient pas quand ils devaient combattre.",
          "reactionCounts": "{}"
        },
        {
          "uid": "entre-climatoscepticisme-et-eco-anxiete-quel-est-notre-rapport-a-linformation",
          "group": {
            "name": "Bureau du Développement Durable",
            "pictureFile": "groups/bdd-n7.png",
            "pictureFileDark": "groups/dark/bdd-n7.png"
          },
          "title": "Entre climatoscepticisme et éco-anxiété, quel est notre rapport à l'information?",
          "notifiedAt": "2024-03-15T12:51:28.506Z",
          "event": {
            "title": "Table ronde BDD sur le climatoscepticisme et l'écoanxiété",
